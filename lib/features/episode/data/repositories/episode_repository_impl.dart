...
class EpisodeRepositoryImpl implements EpisodeRepository {
  ...
  @override
  Future<Either<Failure, List<Episode>>> getEpisodes(String animeId, {int offset = 0, int limit = 20}) async {
    try {
      final episodeModels = await remoteDataSource.getEpisodes(animeId, offset: offset, limit: limit);
