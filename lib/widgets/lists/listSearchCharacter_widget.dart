        ...
        switch (storeSearch.searchResultsCharacters.status) {
          ...
          case FutureStatus.fulfilled:
            if (storeSearch.searchResultsCharacters.value.isEmpty) {
              return ErrorLoading(msg: "Not found character", refresh: _refresh);
            }
            return ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return GestureDetector(
                    onTap: (){
                      Navigator.of(context).pushNamed("/characterInfo",arguments:storeSearch.searchResultsCharacters.value[index]);
                    },
                    child: CharacterSearchTile(
                        character: storeSearch.searchResultsCharacters.value[index]),
                  );
                });
          default:
