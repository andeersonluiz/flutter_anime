...
class Settings extends StatelessWidget {
  final locations = [translate("dialog_settings.english_item"),translate("dialog_settings.portuguese_item")];
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(translate('dialog_settings.language'),style: TextStyle(fontSize: 20),),
          ),
 Padding(
   padding: const EdgeInsets.all(8.0),
   child: Observer(builder: (_) {
                return DropdownButton(
                    ...
                    hint: Center(child: Text(translate('dialog_settings.select_language'))),
