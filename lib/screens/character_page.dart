          ...
          builder:(_){
            ...
            switch(storeCharacters.listCharacters.status){
              ...
              case FutureStatus.rejected:
                return ErrorLoading(msg:"Erro to load characters, verify your connection.",refresh:_refresh);
              case FutureStatus.fulfilled:
                return Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: ListCharacter(characters:storeCharacters.listCharacters.value,scrollController:_scrollController,loadedAllList:storeCharacters.loadedAllList,crossAxisCount:4),
                );
              default:
                return ErrorLoading(msg:"Erro to load characters,try again later.",refresh:_refresh);
