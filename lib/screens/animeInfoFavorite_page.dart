...
class AnimeInfoPageFavorite extends StatefulWidget {
  final Anime anime;
  final index;
  AnimeInfoPageFavorite(this.anime, this.index);

  @override
  _AnimeInfoPageFavoriteState createState() => _AnimeInfoPageFavoriteState();
}

class _AnimeInfoPageFavoriteState extends State<AnimeInfoPageFavorite> {
  ...
  Widget build(BuildContext context) {
    ...
    if (storeAnimesFavorites.favoriteList.length !=
        storeAnimesFavorites.favoriteAnimes.value.length) {
      storeAnimesFavorites.favoriteList
          .removeAt(storeAnimesFavorites.lastIndex);
    }
